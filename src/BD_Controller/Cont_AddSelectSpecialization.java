...
public class Cont_AddSelectSpecialization {
...
//-------------------------------------------------------------------------------------------------------
        ...
        Button_InsertCardCounterparty.setOnAction(event -> {
            ...
            if (TableView_Select_Specialization.getSelectionModel().getSelectedItem() != null) {
                ...
                Const.CardCounterparty_Specialization = selectedPerson.getColumn1();
                Const.Id_Specialization = selectedPerson.getColumn2();
